...
## Metadata
- Author: [[Tiago Forte]]
- Full Title: The PARA Method: A Universal System for Organizing Digital Information
...
- It operates according to three core principles:
  The first principle is that it uses the number 4 as a guidepost. The entire hierarchy is four categories wide (projects, areas, resources, archives), and no more than four levels deep (using Evernote as an example, the levels would be: application > stacks > notebooks > note
