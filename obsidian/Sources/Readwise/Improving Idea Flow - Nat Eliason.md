...
![Improving Idea Flow - Nat Eliason-cover](https://readwise-assets.s3.amazonaws.com/static/images/article0.00998d930354.png)
...
- Go through your Twitter, Feedly, Podcast, or YouTube feed and see what sources are saying the same things in different ways. Now of those, which are your favorites. Keep one or two, and ditch the rest.
...
- Having conversations helps you hone the ideas that are starting to form. It forces you to try to explain them on the fly, realize where they're faulty, and then continue annealing them in subsequent conversations.
